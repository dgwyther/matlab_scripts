...
% season calculates the annual cycle or "climatology" of a time series. 
% 
%% Syntax 
% 
%  [As,ts] = season(A,t) 
...
%  [As,ts] = season(...,'method',DetrendOption) 
...
%
% [As,ts] = season(...,'method',DetrendOption) specifies a baseline relative to which seasonal anomalies are 
...
% 
% See also: deseason, detrendn, and datenum. 
