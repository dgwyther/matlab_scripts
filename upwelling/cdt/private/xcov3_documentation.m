%% |xcov3| documentation 
% The |xcov3| function gives a map of covariance between grid cells of a 3D spatiotemporal dataset 
% and a reference time series.  This function is quite similar to <xcorr3_documentation.html |xcorr3|>.
% 
...
%% Description
% 
% |r = xcov3(A,ref)| gives a 2D correlation map |r|, which has dimensions corresponding to dimensions 1 and 2 of |A|. The 3D matrix
...
% The example above is intended to give a sense of the theory behind how |xcov3| works, 
% but it doesn't capture the insights of spatiotemporal patterns you can get by applying 
% |xcov3| to real data.  So let's take a look at a sample reanalysis dataset of sea surface
% temperatures: 
...
%% 
% Before using |xcov3| you can remove the mean manually if you'd like, or you can simply use 
...
[r0,rmax,lags] = xcov3(sst,ref,'maxlags',6,'detrend'); 
...
%% Author Info
% The |xcov3| function and supporting documentation were written by <http://www.chadagreene.com Chad A. Greene> of the University of Texas
