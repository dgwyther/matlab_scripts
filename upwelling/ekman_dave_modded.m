...
if nargin>4
   ...
   % Check for user grid spacing:
   tmpDX = strcmpi(varargin,'DX');
   disp('custom user grid spacing')
end
...
UE = bsxfun(@rdivide,Taux,(rho.*f)); % m^2/s
VE = bsxfun(@rdivide,Tauy,(rho.*f)); % m^2/s %%% WHY NEGATIVE?
